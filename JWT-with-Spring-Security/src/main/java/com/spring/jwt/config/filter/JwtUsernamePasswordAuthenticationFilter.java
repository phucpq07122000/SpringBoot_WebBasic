...
import com.spring.jwt.dto.JwtReponseDTO;
...
public class JwtUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        JwtReponseDTO jwtReponseDTO=JwtReponseDTO.builder()
                .token(accessToken)
                .userName(userDetailsCustom.getUsername())
                .build();
        String json = HelperUtils.JSON_WRITER.writeValueAsString(jwtReponseDTO);
